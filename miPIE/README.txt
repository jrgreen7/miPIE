1. Download the METHODNAME files from github.com/jrgreen7/methodname 
...
4. Within your miRDeep2 installation, replace the miRDeep2.pl and mirdeep_core_algorithm.pl files with those provided in the METHODNAME package.

5. Run the miRDeep2 pipeline on your NGS data set, as directed by the miRDeep2 instructions.

6. Run the predict.py python script from the base folder of the METHODNAME installation. The script requires one input, -d, which is the location of the output.mrd file generated in step 5 of these instructions. A typical command line for this script is as follows:
